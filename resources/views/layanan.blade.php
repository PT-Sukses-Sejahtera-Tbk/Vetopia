...
@section('container')
    <div class="my-10 text-gray-900 font-sans text-center">
        ...
        <p class="my-10 text-xl font-normal">Kami menyediakan berbagai layanan kesehatan untuk hewan kesayangan Anda. Pilih layanan <br>yang sesuai dengan kebutuhan Anda.</p>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 pb-20">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <a href="/booking-konsultasi" class="bg-white rounded-3xl border border-gray-200 p-8 text-center hover:shadow-lg transition-shadow block">
                ...
                <p class="text-gray-600 leading-relaxed">Jadwalkan konsultasi dengan dokter hewan profesional kami di klinik. Dapatkan layanan terbaik untuk hewan Anda.</p>
            </a>
            ...
            <a href="/konsultasi-online" class="bg-white rounded-3xl border border-gray-200 p-8 text-center hover:shadow-lg transition-shadow block">
                ...
                <p class="text-gray-600 leading-relaxed">Pemeriksaan kesehatan menyeluruh untuk hewan kesayangan Anda. Deteksi dini masalah kesehatan hewan Anda.</p>
            </a>

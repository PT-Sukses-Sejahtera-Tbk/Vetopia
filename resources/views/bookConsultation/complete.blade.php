                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <div class="mt-1 relative rounded-md shadow-sm">
                                    ...
                                    <input type="number" id="biaya" name="biaya" min="0" step="1000"
                                        class="pl-12 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                                        placeholder="0" value="{{ old('biaya') }}" required>
                                </div>
                                @error('biaya')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                                <p class="mt-1 text-sm text-gray-500">Masukkan biaya dalam Rupiah (tanpa titik atau koma)</p>
                            </div>

                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input id="name" type="text" name="name" value="{{ old('name') }}" 
                               class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#65DF73] focus:border-transparent placeholder-gray-400" 
                    ...
                    <div class="mb-3">
                        ...
                        <div class="relative">
                            <input id="password" type="password" name="password" 
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#65DF73] focus:border-transparent pr-12 placeholder-gray-400" 
                    ...
                    <div class="mb-4">
                        <label class="flex items-start">
                            <input type="checkbox" class="mt-1 rounded border-gray-300 text-[#65DF73] focus:ring-[#65DF73]" required>
                    ...
                    <!-- Submit Button -->
                    <button type="submit" 
                            class="w-full bg-vetopia-green hover:bg-[#4EC95E] text-black font-semibold py-2.5 px-4 rounded-lg transition duration-200">
                        Daftar
                    </button>
                </form>
            </div>

                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input id="email" type="email" name="email" value="{{ old('email') }}" 
                               class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#65DF73] focus:border-transparent placeholder-gray-400" 
                    ...
                    <div class="mb-3">
                        ...
                        <div class="relative">
                            <input id="password" type="password" name="password" 
                                   class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#65DF73] focus:border-transparent pr-12 placeholder-gray-400" 
                    ...
                    <div class="flex items-center justify-between mb-4">
                        <label class="flex items-center">
                            <input id="remember_me" type="checkbox" class="rounded border-gray-300 text-[#65DF73] focus:ring-[#65DF73]" name="remember">
                    ...
                    <!-- Submit Button -->
                    <button type="submit" 
                            class="w-full bg-vetopia-green hover:bg-[#4EC95E] text-black font-semibold py-2.5 px-4 rounded-lg transition duration-200 mb-3">
                        Masuk
                    </button>
                    ...
                    <p class="text-center text-sm text-gray-600">
                        Belum punya akun? 
                        <a href="{{ route('register') }}" class="text-vetopia-green hover:text-[#4EC95E] font-medium">
                            Daftar sekarang
                        </a>
                    </p>
                </form>
